...
module.exports = "<app-navbar></app-navbar>\r\n<div class = \"lang\">\r\n    <img width = \"30\" height = \"30\" alt = \"en\" src = \"angular2-simple-website/assets/images/lang/en.jpg\" (click)='lang.setDefaultLang(selectedLang=\"en\")'/>\r\n    <img width = \"30\" height = \"30\" alt = \"fr\" src = \"angular2-simple-website/assets/images/lang/tn.jpg\" (click)='lang.setDefaultLang(selectedLang=\"fr\")'/>\r\n</div>\r\n<app-sidebar></app-sidebar>\r\n<router-outlet></router-outlet>\r\n<app-footer></app-footer>"
...
var BannerService = (function () {
    function BannerService(_http) {
        ...
        this._bannerdataurl = 'angular2-simple-website/assets/json/banner.json';
    }
...
var GalleryComponent = (function () {
    function GalleryComponent(_galleryData, modalService) {
    ...
    GalleryComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__gallery_gallery_service__["a" /* GalleryService */], __WEBPACK_IMPORTED_MODULE_1_ngx_bootstrap_modal__["a" /* BsModalService */]])
    ], GalleryComponent);
...
var GalleryService = (function () {
    function GalleryService(_http) {
        this._http = _http;
        this._gallerydataurl = 'angular2-simple-website/assets/json/gallery.json';
    }
...
var HomeComponent = (function () {
    function HomeComponent(_rankholdersData, _moreeeventsData, modalService) {
    ...
    HomeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__rankholders_rankholders_service__["a" /* RankholdersService */], __WEBPACK_IMPORTED_MODULE_3__moreevents_moreevents_service__["a" /* MoreeventsService */], __WEBPACK_IMPORTED_MODULE_1_ngx_bootstrap_modal__["a" /* BsModalService */]])
    ], HomeComponent);
...
var LoginService = (function () {
    function LoginService(_http) {
        ...
        this._loginURL = "angular2-simple-website/assets/json/login.json";
    }
...
var MailusService = (function () {
    function MailusService(_http) {
        ...
        this._mailusurl = 'angular2-simple-website/assets/json/mailus.json';
    }
...
var MoreeventsService = (function () {
    function MoreeventsService(_http) {
        ...
        this._eventdataurl = 'angular2-simple-website/assets/json/moreevents.json';
    }
    /*
...
module.exports = "    <div id=\"home\">\r\n\t\t<div class=\"banner_nav\">\r\n\t\t\t<nav class=\"navbar navbar-default\">\r\n\t\t\t\t<div class=\"navbar-header navbar-left\">\r\n\t\t\t\t\t<button type=\"button\" class=\"navbar-toggle {{btnClass}}\" (click)=\"toggleCollapse()\">\r\n\t\t\t\t\t\t<span class=\"sr-only\">Toggle navigation</span>\r\n\t\t\t\t\t\t<span class=\"icon-bar\"></span>\r\n\t\t\t\t\t\t<span class=\"icon-bar\"></span>\r\n\t\t\t\t\t\t<span class=\"icon-bar\"></span>\r\n\t\t\t\t\t</button>\r\n\t\t\t\t\t<h1><a class=\"navbar-brand\"  [routerLink] = \"['']\"> <span>T</span>echie Inside</a></h1>\r\n\r\n\t\t\t\t</div>\r\n\t\t\t\t<!-- Collect the nav links, forms, and other content for toggling -->\r\n\t\t\t\t<div class=\"collapse navbar-collapse navbar-right {{navClass}}\">\r\n\t\t\t\t\t<nav class=\"menu-hover-effect menu-hover-effect-4\">\r\n\t\t\t\t\t\t<ul class=\"nav navbar-nav\">\r\n\t\t\t\t\t\t\t<li [routerLinkActive]=\"['active']\"  [routerLinkActiveOptions]=\"{exact:true}\"><a  [routerLink] = \"['']\" class=\"hvr-ripple-in\"> Home</a></li>\r\n\t\t\t\t\t\t\t<li [routerLinkActive]=\"['active']\"  [routerLinkActiveOptions]=\"{exact:true}\"><a  [routerLink] = \"['/technologies']\" class=\"hvr-ripple-in\">Technologies</a></li>\r\n\t\t\t\t\t\t\t<li [routerLinkActive]=\"['active']\"  [routerLinkActiveOptions]=\"{exact:true}\"><a  [routerLink] = \"['/projects']\" class=\"hvr-ripple-in\">Projects</a></li>\r\n\t\t\t\t\t\t\t<li [routerLinkActive]=\"['active']\"  [routerLinkActiveOptions]=\"{exact:true}\"><a  [routerLink] = \"['/moreevents']\" class=\"hvr-ripple-in\">Achievements</a></li>\r\n\t\t\t\t\t\t\t<li [routerLinkActive]=\"['active']\"  [routerLinkActiveOptions]=\"{exact:true}\"><a [routerLink] = \"['/resume']\" class=\"hvr-ripple-in\"  *ngIf=\"isLoggedIn != null\">Resume</a></li>\r\n\t\t\t\t\t\t\t<li [routerLinkActive]=\"['active']\"  [routerLinkActiveOptions]=\"{exact:true}\"><a [routerLink] = \"['/mailus']\" class=\"hvr-ripple-in\">Mail Us</a></li>\r\n\t\t\t\t\t\t</ul>\r\n\t\t\t\t\t\t<app-login></app-login>\r\n\t\t\t\t\t</nav>\r\n\r\n\t\t\t\t</div>\r\n\t\t\t</nav>\r\n\t\t\t<div class=\"clearfix\"> </div>\r\n\t\t</div>\r\n\t</div>\r\n"
...
var ProjectComponent = (function () {
    function ProjectComponent(_projectData, modalService) {
    ...
    ProjectComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__projects_projects_service__["a" /* ProjectService */], __WEBPACK_IMPORTED_MODULE_1_ngx_bootstrap_modal__["a" /* BsModalService */]])
    ], ProjectComponent);
...
var ProjectService = (function () {
    function ProjectService(_http) {
        this._http = _http;
        /* private _eventdataurl='http://localhost/school/events.php'; */
        this._projectdataurl = 'angular2-simple-website/assets/json/projects.json';
    }
    /*
...
var RankholdersService = (function () {
    function RankholdersService(_http) {
        this._http = _http;
        this._rankholdersdataurl = 'angular2-simple-website/assets/json/rankholders.json';
    }
...
module.exports = "<div class=\"rank_head_section\">\n  <h3 class=\"rank_header\">My <span>Resume</span></h3>\n</div>\n<div class=\"container\">\n        <object src=\"angular2-simple-website/assets/resume/AKILESH_KUMAR_R.pdf\">\n          <embed src=\"angular2-simple-website/assets/resume/AKILESH_KUMAR_R.pdf\" width=\"100%\" height=\"1500px\"/>\n        </object>\n</div>"
